...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.hourly_limit'
        db.add_column('scheduler_unit', 'hourly_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.hourly_limit'
        db.delete_column('scheduler_unit', 'hourly_limit')
    ...
    models = {
        ...
        'scheduler.shift': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_worker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scheduler.Worker']", 'null': 'True', 'related_name': "'shift_originalWorker'", 'default': 'None', 'blank': 'True'}),
            ...
            'substitute_worker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scheduler.Worker']", 'null': 'True', 'related_name': "'shift_substituteWorker'", 'default': 'None', 'blank': 'True'}),
