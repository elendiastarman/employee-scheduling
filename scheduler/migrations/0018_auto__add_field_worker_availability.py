...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.availability'
        db.add_column('scheduler_worker', 'availability',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Worker.availability'
        db.delete_column('scheduler_worker', 'availability')
    ...
    models = {
        ...
        'scheduler.announcement': {
            ...
            'date_to_destroy': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'scheduler.shift': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_worker': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['scheduler.Worker']", 'default': 'None', 'related_name': "'shift_originalWorker'", 'blank': 'True'}),
            ...
            'substitute_worker': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['scheduler.Worker']", 'default': 'None', 'related_name': "'shift_substituteWorker'", 'blank': 'True'}),
