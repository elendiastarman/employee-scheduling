...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Term.unit'
        db.add_column('scheduler_term', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scheduler.Unit'], default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Term.unit'
        db.delete_column('scheduler_term', 'unit_id')
    ...
    models = {
        ...
        'scheduler.position': {
            ...
            'block': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scheduler.Block']", 'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'scheduler.shift': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_worker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scheduler.Worker']", 'default': 'None', 'null': 'True', 'related_name': "'shift_originalWorker'", 'blank': 'True'}),
            ...
            'substitute_worker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['scheduler.Worker']", 'default': 'None', 'null': 'True', 'related_name': "'shift_substituteWorker'", 'blank': 'True'}),
        ...
        'scheduler.unit': {
            ...
            'weekdays': ('django.db.models.fields.CharField', [], {'default': "'MTWRF'", 'max_length': '8'})
        },
