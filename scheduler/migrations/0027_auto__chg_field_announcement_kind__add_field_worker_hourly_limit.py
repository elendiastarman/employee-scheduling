...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Announcement.kind'
        db.alter_column('scheduler_announcement', 'kind', self.gf('django.db.models.fields.CharField')(max_length=3))
        # Adding field 'Worker.hourly_limit'
        db.add_column('scheduler_worker', 'hourly_limit',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Announcement.kind'
        db.alter_column('scheduler_announcement', 'kind', self.gf('django.db.models.fields.CharField')(max_length=2))
        # Deleting field 'Worker.hourly_limit'
        db.delete_column('scheduler_worker', 'hourly_limit')
    ...
    models = {
        ...
        'scheduler.announcement': {
            ...
            'date_to_delete': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'blank': 'True', 'max_length': '200'}),
            'kind': ('django.db.models.fields.CharField', [], {'default': "'3An'", 'max_length': '3'}),
        ...
        'scheduler.shift': {
            ...
            'chain_nex': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'chain_bef'", 'default': 'None', 'unique': 'True', 'null': 'True', 'to': "orm['scheduler.Shift']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_worker': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shift_originalWorker'", 'default': 'None', 'null': 'True', 'blank': 'True', 'to': "orm['scheduler.Worker']"}),
            ...
            'substitute_worker': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shift_substituteWorker'", 'default': 'None', 'null': 'True', 'blank': 'True', 'to': "orm['scheduler.Worker']"}),
