...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Block', fields ['name']
        db.delete_unique('scheduler_block', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Block', fields ['name']
        db.create_unique('scheduler_block', ['name'])
