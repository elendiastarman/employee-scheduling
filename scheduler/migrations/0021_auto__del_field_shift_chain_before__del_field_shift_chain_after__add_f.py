...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Shift.chain_nex'
        db.add_column('scheduler_shift', 'chain_nex',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='chain_bef', default=None, unique=True, to=orm['scheduler.Shift'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('scheduler_shift', 'chain_before',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.Shift'], default=None, unique=True, null=True, related_name='chain_bef'),
                      keep_default=False)

        # Adding field 'Shift.chain_after'
        db.add_column('scheduler_shift', 'chain_after',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.Shift'], default=None, unique=True, null=True, related_name='chain_nex'),
                      keep_default=False)

        # Deleting field 'Shift.chain_nex'
        db.delete_column('scheduler_shift', 'chain_nex_id')
    ...
    models = {
        ...
        'scheduler.shift': {
            ...
            'chain_nex': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'chain_bef'", 'default': 'None', 'unique': 'True', 'to': "orm['scheduler.Shift']", 'null': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_worker': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'default': 'None', 'to': "orm['scheduler.Worker']", 'related_name': "'shift_originalWorker'", 'null': 'True'}),
            ...
            'substitute_worker': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'default': 'None', 'to': "orm['scheduler.Worker']", 'related_name': "'shift_substituteWorker'", 'null': 'True'}),
